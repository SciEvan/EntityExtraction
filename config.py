...
BATCH_SIZE = environ.setdefault('BATCH_SIZE', '4')
EPOCHS = environ.setdefault('EPOCHS', '3')
MAX_WORD_LENGTH = environ.setdefault('MAX_WORD_LENGTH', '125')
LEARNING_RATE = environ.setdefault('LEARNING_RATE', '0.001')
SAVE_MODEL_DIR = environ.setdefault('SAVE_MODEL_DIR', 'models/2')
